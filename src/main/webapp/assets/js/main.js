...
function initialize() {
    ...
    var coordLat = 32.944167;
    var coordLng = -96.976823;
    var delta;
...
jQuery.fn.parallax = function () {
    ...
    this.each(function () {
        ...
        if (winWidth > 1024) {
            ...
            parallaxContainer.css({
                'left': '0px',
                '-webkit-transform': 'translateY(' + parseInt((img.height() - bgobj.outerHeight()) / -2, 10) + 'px) translateZ(0)',
                '-moz-transform': 'translateY(' + parseInt((img.height() - bgobj.outerHeight()) / -2, 10) + 'px) translateZ(0)',
                '-ms-transform': 'translateY(' + parseInt((img.height() - bgobj.outerHeight()) / -2, 10) + 'px) translateZ(0)',
                'transform': 'translateY(' + parseInt((img.height() - bgobj.outerHeight()) / -2, 10) + 'px) translateZ(0)'
            });

            if (img.height() < parallaxContainer.height()) {
                img.css('width', img.width() * (bgobj.outerHeight() / img.height()));
                parallaxContainer.css({
                    'left': +parseInt((img.width() - parallaxContainer.width()) / -2, 10) + 'px',
